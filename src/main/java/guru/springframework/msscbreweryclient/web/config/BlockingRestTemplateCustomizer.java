 ...
 *
 * Sets up apache http rest template ( httpasyncclient in pom )
 * Performs better than default spring template (netty?)
 *
 */
@Component
public class BlockingRestTemplateCustomizer implements RestTemplateCustomizer {
    ...
    // Constructor to load externalised values from application.properties file
